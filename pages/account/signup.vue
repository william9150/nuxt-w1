    ...
    <div class="p-5 px-md-0 py-md-30">
      ...
      <div class="mb-4">
        <form :class="{ 'd-none': isEmailAndPasswordValid }" class="mb-4">
          ...
          <button class="btn btn-neutral-40 w-100 py-4 text-neutral-60 fw-bold" type="button" @click="isEmailAndPasswordValid = true">
            下一步
          </button>
        </form>
        <form :class="{ 'd-none': !isEmailAndPasswordValid }" class="mb-4">
          ...
          <button class="btn btn-primary-100 w-100 py-4 text-neutral-0 fw-bold" type="button">完成註冊</button>
        </form>
      </div>
