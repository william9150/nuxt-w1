        ...
        <div class="row gap-10 gap-md-0">
          ...
          <div class="col-12 col-md-5">
            <div class="confirm-form rounded-3xl d-flex flex-column gap-10 p-6 p-md-10 mx-auto ms-md-auto me-md-0 bg-neutral-0">
              <img class="img-fluid rounded-3" :src="`${baseURL}images/room-${route.params.roomId}-1.png`" alt="room-a" />
              ...
              <button class="btn btn-primary-100 py-4 text-neutral-0 fw-bold rounded-3" type="button" @click="confirmBooking">
                確認訂房
              </button>
            </div>
          </div>
