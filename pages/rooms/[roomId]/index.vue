  ...
  <main class="mt-18 mt-md-30 bg-neutral-100">
    <section class="p-md-20 bg-primary-10">
      <div class="d-none d-md-block position-relative">
        <div class="d-flex gap-2 rounded-3xl overflow-hidden">
          <div style="width: 52.5vw">
            <img class="w-100" :src="`${baseURL}images/room-${route.params.roomId}-1.png`" :alt="`room-${route.params.roomId}-1`" />
          </div>
          <div class="d-flex flex-wrap gap-md-2" style="width: 42.5vw">
            <div class="d-flex gap-md-2">
              <img class="w-50" :src="`${baseURL}images/room-${route.params.roomId}-2.png`" :alt="`room-${route.params.roomId}-2`" />
              <img class="w-50" :src="`${baseURL}images/room-${route.params.roomId}-3.png`" :alt="`room-${route.params.roomId}-3`" />
            </div>
            <div class="d-flex gap-md-2">
              <img class="w-50" :src="`${baseURL}images/room-${route.params.roomId}-4.png`" :alt="`room-${route.params.roomId}-4`" />
              <img class="w-50" :src="`${baseURL}images/room-${route.params.roomId}-5.png`" :alt="`room-${route.params.roomId}-5`" />
            </div>
          </div>
        </div>
        <button
      ...
      <div class="d-md-none position-relative">
        <img class="img-fluid" :src="`${baseURL}images/room-${route.params.roomId}-1.png`" :alt="`room-${route.params.roomId}-1`" />
        <button
    ...
    <section class="py-10 py-md-30 bg-primary-10">
        ...
        <div class="row">
          <div class="col-12 col-md-7 d-flex flex-column gap-6 gap-md-20">
            <div>
              ...
              <p class="mb-0 text-neutral-80 fs-8 fs-md-7 fw-medium">享受高級的住宿體驗，尊爵雙人房提供給您舒適寬敞的空間和精緻的裝潢。</p>
            </div>
      ...
      <div class="d-flex d-md-none justify-content-between align-items-center position-fixed bottom-0 w-100 p-3 bg-neutral-0">
        <template v-if="bookingDate.date.end === null">
          ...
          <button class="btn btn-primary-100 px-12 py-4 text-neutral-0 fw-bold rounded-3" type="button" @click="openModal">
            查看可訂日期
          </button>
        </template>
