...
const roomImages = computed(() => {
  ...
  const result = rooms.reduce((acc, roomId) => {
    acc[`room${roomId.toUpperCase()}`] = nums.reduce((obj, num) => {
      obj[num] = {
        desktop: importImage(`../../assets/images/room-${roomId}-${num}.png`), //`@/assets/images/room-${roomId}-${num}.png`,
        mobile: importImage(`../../assets/images/room-${roomId}-sm-${num}.png`), //`@/assets/images/room-${roomId}-sm-${num}.png`,
      };
      return obj;
    }, {});
                ...
                >
                  <swiper-slide v-for="(num, index) in 5" :key="index">
                    <picture>
                      ...
                      <img class="w-100 object-fit-cover" :src="roomImages.roomA[num].mobile" loading="lazy" :alt="`room-a-${num}`" />
                    </picture>
                  </swiper-slide>
                </swiper>
              </div>
                ...
                >
                  <swiper-slide v-for="(num, index) in 5" :key="index">
                    <picture>
                      ...
                      <img class="w-100 object-fit-cover" :src="roomImages.roomB[num].mobile" loading="lazy" :alt="`room-b-${num}`" />
                    </picture>
                  </swiper-slide>
                </swiper>
              </div>
                ...
                >
                  <swiper-slide v-for="(num, index) in 5" :key="index">
                    <picture>
                      ...
                      <img class="w-100 object-fit-cover" :src="roomImages.roomC[num].mobile" loading="lazy" :alt="`room-c-${num}`" />
                    </picture>
                  </swiper-slide>
                </swiper>
              </div>
                ...
                >
                  <swiper-slide v-for="(num, index) in 5" :key="index">
                    <picture>
                      ...
                      <img class="w-100 object-fit-cover" :src="roomImages.roomD[num].mobile" loading="lazy" :alt="`room-d-${num}`" />
                    </picture>
                  </swiper-slide>
                </swiper>
              </div>
